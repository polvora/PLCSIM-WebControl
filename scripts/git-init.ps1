...
Write-Host ""
Write-Host "     git remote add origin https://github.com/<your-user>/PLCSIM-AutoStart.git"
Write-Host "     git push -u origin main"
Write-Host ""
Write-Host "  3) Create a Release (tag v1.0.0) and attach dist\PLCSIM-AutoStart-1.0.0.zip"
